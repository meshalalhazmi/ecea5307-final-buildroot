...
RPI_DEFCONFIG=configs/raspberrypi5_defconfig
...
AESD_QEMU_DEFAULT_DEFCONFIG=${QEMU_DEFCONFIG}
AESD_QEMU_MODIFIED_DEFCONFIG=${MODIFIED_QEMU_DEFCONFIG}
AESD_QEMU_MODIFIED_DEFCONFIG_REL_BUILDROOT=../${AESD_QEMU_MODIFIED_DEFCONFIG}